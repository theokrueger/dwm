...
static Key keys[] = {
	/* applications */
	{MODKEY, XK_Return, spawn, {.v = app_terminal}},
	{MODKEY | ShiftMask, XK_f, spawn, {.v = app_webbrowser}},
	{MODKEY | ControlMask, XK_f, spawn, {.v = app_webbrowser2}},
	{MODKEY | ShiftMask, XK_g, spawn, {.v = app_filemanager}},
	{MODKEY | ShiftMask, XK_e, spawn, {.v = app_editor}},
