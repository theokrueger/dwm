...
static const char *ssccmd[]      = { "escrotum", "-s", "-c", NULL };                                                  // bound to mod-ctrl-shift-prtsc
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask|ShiftMask, XK_Print,                  spawn,          {.v = ssccmd } },             // take screenshot with selection and only copy to clipboard (escrotum)
